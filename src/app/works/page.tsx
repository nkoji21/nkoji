...
const WORKS = [
  {
    ...
    body: "立ち上げ初期のフロントエンドを、デザインから実装まで担当しています。並行してタブレット向け Web アプリの受託も一人で進めていて、現地に足を運んで実機で検証しながらつくりました。",
  ...
  },
  {
    ...
    isOngoing: false,
    title: "リサーチと提案資料づくり",
    body: "競合リサーチや提案資料の作成、Figma でのワイヤーフレーム制作を担当。コードを書く以外にもプロジェクトが前に進まなくなる理由があることを知った時期です。",
    tags: ["Figma", "GAS"],
  },
  {
