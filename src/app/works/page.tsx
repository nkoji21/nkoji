...
const WORKS = [
  {
    ...
    isOngoing: true,
    title: "テスト自動化プロダクトと、タブレット向けアプリの受託",
    body: "テスト自動化プロダクトでは立ち上げ初期のフロントエンドを、デザインから実装まで担当。小さめのデザインシステムも整えました。並行して進めたタブレット向け Web アプリの受託では、実機を持って箱根まで行き、現地で使ってもらいながら検証しました。要望をそのまま作るのではなく、本当に解決したいことは何かを整理して、やること・やらないことを決めるところから関わっています。",
