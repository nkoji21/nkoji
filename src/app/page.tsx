...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-8 px-5 pb-24 md:flex-row md:gap-24 md:pb-0">
      ...
      */}
      <div className="anim-float-up anim-delay-500 size-45 md:order-2 md:size-64">
        <AvatarButton className="size-full" />
      </div>
      <div className="flex flex-col items-center gap-2 md:order-1 md:items-start">
        <h1 className="anim-slide-up font-display text-5xl text-foreground md:text-7xl">
          nkoji
        </h1>
        <p className="anim-slide-up anim-delay-250 font-bold text-accent tracking-logo md:text-2xl">
